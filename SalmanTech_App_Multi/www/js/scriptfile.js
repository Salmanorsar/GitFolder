...
$("#ComExconMain").live("pageinit", function() {	
	...
	$('#ComSave').bind('tap', function(event, ui) {	
		...
		window.localStorage.setItem('ComExamInput1', $('#ComEx1').val());
		window.localStorage.setItem('ComExamInput2', $('#ComEx2').val());
		window.localStorage.setItem('ComExamInput3', $('#ComEx3').val());
		window.localStorage.setItem('ComExamInput4', $('#ComEx4').val());
		window.localStorage.setItem('ComExamInput5', $('#ComEx5').val());
		window.localStorage.setItem('ComExamInput6', $('#ComEx6').val());
		
		window.localStorage.setItem('ComConOutput1', $('#ComCon1').val());
		window.localStorage.setItem('ComConOutput2', $('#ComCon2').val());
		window.localStorage.setItem('ComConOutput3', $('#ComCon3').val());
		window.localStorage.setItem('ComConOutput4', $('#ComCon4').val());
		window.localStorage.setItem('ComConOutput5', $('#ComCon5').val());
		window.localStorage.setItem('ComConOutput6', $('#ComCon6').val());
		
		
		window.localStorage.setItem('ComTGOutput1', $('#ComTG1').val());
		window.localStorage.setItem('ComTGOutput2', $('#ComTG2').val());
		window.localStorage.setItem('ComTGOutput3', $('#ComTG3').val());
		window.localStorage.setItem('ComTGOutput4', $('#ComTG4').val());
		window.localStorage.setItem('ComTGOutput5', $('#ComTG5').val());
		window.localStorage.setItem('ComTGOutput6', $('#ComTG6').val());
		
		//Save the complete Average Grade Points
		window.localStorage.setItem('ComHomeOutput1', $('#ComGradeOne').val());
		window.localStorage.setItem('ComHomeOutput2', $('#ComGradeTwo').val());
		window.localStorage.setItem('ComHomeOutput3', $('#ComGradeThree').val());
		window.localStorage.setItem('ComHomeOutput4', $('#ComGradeFour').val());
		window.localStorage.setItem('ComHomeOutput5', $('#ComGradeFive').val());
		window.localStorage.setItem('ComHomeOutput6' , $('#ComGradeSix').val());
		
		window.localStorage.setItem('ComHomeAGP', $('#ComAverageGP').val());
	});
	
	$('#ComRetrieve').bind("tap", function(event, ui) {
	
		//Retrieve the Complete Exam and Continuous Grades
		$('#ComEx1').val(window.localStorage.getItem('ComExamInput1'));
		$('#ComEx2').val(window.localStorage.getItem('ComExamInput2'));
		$('#ComEx3').val(window.localStorage.getItem('ComExamInput3'));
		$('#ComEx4').val(window.localStorage.getItem('ComExamInput4'));
		$('#ComEx5').val(window.localStorage.getItem('ComExamInput5'));
		$('#ComEx6').val(window.localStorage.getItem('ComExamInput6'));
		
		$('#ComCon1').val(window.localStorage.getItem('ComConOutput1'));
		$('#ComCon2').val(window.localStorage.getItem('ComConOutput2'));
		$('#ComCon3').val(window.localStorage.getItem('ComConOutput3'));
		$('#ComCon4').val(window.localStorage.getItem('ComConOutput4'));
		$('#ComCon5').val(window.localStorage.getItem('ComConOutput5'));
		$('#ComCon6').val(window.localStorage.getItem('ComConOutput6'));
		
		$('#ComTG1').val(window.localStorage.getItem('ComTGOutput1'));
		$('#ComTG2').val(window.localStorage.getItem('ComTGOutput2'));
		$('#ComTG3').val(window.localStorage.getItem('ComTGOutput3'));
		$('#ComTG4').val(window.localStorage.getItem('ComTGOutput4'));
		$('#ComTG5').val(window.localStorage.getItem('ComTGOutput5'));
		$('#ComTG6').val(window.localStorage.getItem('ComTGOutput6'));
		
		//Retrive the Complete Average Grade Points
		$('#ComGradeOne').val(window.localStorage.getItem('ComHomeOutput1'));
		$('#ComGradeTwo').val(window.localStorage.getItem('ComHomeOutput2'));
		$('#ComGradeThree').val(window.localStorage.getItem('ComHomeOutput3'));
		$('#ComGradeFour').val(window.localStorage.getItem('ComHomeOutput4'));
		$('#ComGradeFive').val(window.localStorage.getItem('ComHomeOutput5'));
		$('#ComGradeSix').val(window.localStorage.getItem('ComHomeOutput6'));
		
		$('#ComAverageGP').val(window.localStorage.getItem('ComHomeAGP'));
	});
		
	$("#ComexconCalBtn").bind("tap", function() {
		...
		$('#ComTG6').val("");
		//Clear Error markings from input boxes
				$('#ComEx1').css({"color" : "#000000"});
		$('#ComCon1').css({"color" : "#000000"});
		
		$('#ComEx2').css({"color" : "#000000"});
		$('#ComCon2').css({"color" : "#000000"});
		
		$('#ComEx3').css({"color" : "#000000"});
		$('#ComCon3').css({"color" : "#000000"});
		
		$('#ComEx4').css({"color" : "#000000"});
		$('#ComCon4').css({"color" : "#000000"});
		
		$('#ComEx5').css({"color" : "#000000"});
		$('#ComCon5').css({"color" : "#000000"});
		
		$('#ComEx6').css({"color" : "#000000"});
		$('#ComCon6').css({"color" : "#000000"});	
						
							 
		// Checking range of exams values				// Checking range of continuous values
		var checkex1 = parseFloat($('#ComEx1').val());		var checkcon1 = parseFloat($('#ComCon1').val());
		var checkex2 = parseFloat($('#ComEx2').val());		var checkcon2 = parseFloat($('#ComCon2').val());
		var checkex3 = parseFloat($('#ComEx3').val());		var checkcon3 = parseFloat($('#ComCon3').val());
		var checkex4 = parseFloat($('#ComEx4').val());		var checkcon4 = parseFloat($('#ComCon4').val());
		var checkex5 = parseFloat($('#ComEx5').val());		var checkcon5 = parseFloat($('#ComCon5').val());
		var checkex6 = parseFloat($('#ComEx6').val());		var checkcon6 = parseFloat($('#ComCon6').val());

		// Check all Exams grades for char		// Check all continuous grades for char
		var checkNumex1 = $('#ComEx1').val();		var checkNumcon1 = $('#ComCon1').val();
		var checkNumex2 = $('#ComEx2').val();		var checkNumcon2 = $('#ComCon2').val();
		var checkNumex3 = $('#ComEx3').val();		var checkNumcon3 = $('#ComCon3').val();
		var checkNumex4 = $('#ComEx4').val();		var checkNumcon4 = $('#ComCon4').val();
		var checkNumex5 = $('#ComEx5').val();		var checkNumcon5 = $('#ComCon5').val();
		var checkNumex6 = $('#ComEx6').val();		var checkNumcon6 = $('#ComCon6').val();		
		...
		for (var i = 0; i <= 25; i++)
		{
			...
			else
			{
				...
				if((checkex1 >= 0 && checkex1 <= 100) && (checkcon1 >= 0 && checkcon1 <= 100))
				{
					var ex1 = .7 * parseFloat($('#ComEx1').val());
					var con1 = .3 * parseFloat($('#ComCon1').val());
				}
				else
				{
					if(checkex1 < 0 || checkex1 > 100)
					{
						$('#ComEx1').css({"color" : "red"});
					}
					else if(checkcon1 < 0 || checkcon1 > 100)
					{
						$('#ComCon1').css({"color" : "red"});
					}
			...
			else
			{
				...
				if((checkex2 >= 0 && checkex2 <= 100) && (checkcon2 >= 0 && checkcon2 <= 100))
				{
					var ex2 = .7 * parseFloat($('#ComEx2').val());
					var con2 = .3 * parseFloat($('#ComCon2').val());
				}
				else
				{
					...
					if(checkex2 < 0 || checkex2 > 100)
					{
						$('#ComEx2').css({"color" : "red"});
					}
					else if(checkcon2 < 0 || checkcon2 > 100)
					{
						$('#ComCon2').css({"color" : "red"});
					}
			...
			else
			{
				...
				if((checkex3 >= 0 && checkex3 <= 100) && (checkcon3 >= 0 && checkcon3 <= 100))
				{
					var ex3 = .7 * parseFloat($('#ComEx3').val());
					var con3 = .3 * parseFloat($('#ComCon3').val());
				}
				else
				{
					if(checkex3 < 0 || checkex3 > 100)
					{
						$('#ComEx3').css({"color" : "red"});
					}
					else if(checkcon3 < 0 || checkcon3 > 100)
					{
						$('#ComCon3').css({"color" : "red"});
					}
			...
			else
			{
				...
				if((checkex4 >= 0 && checkex4 <= 100) && (checkcon4 >= 0 && checkcon4 <= 100))
				{
					var ex4 = .7 * parseFloat($('#ComEx4').val());
					var con4 = .3 * parseFloat($('#ComCon4').val());
				}
				else
				{
					if(checkex4 < 0 || checkex4 > 100)
					{
						$('#ComEx4').css({"color" : "red"});
					}
					else if(checkcon2 < 0 || checkcon2 > 100)
					{
						$('#ComCon4').css({"color" : "red"});
					}
			...
			else
			{
				...
				if((checkex5 >= 0 && checkex5 <= 100) && (checkcon5 >= 0 && checkcon5 <= 100))
				{
					var ex5 = .7 * parseFloat($('#ComEx5').val());
					var con5 = .3 * parseFloat($('#ComCon5').val());
				}
				else
				{
					if(checkex5 < 0 || checkex5 > 100)
					{
						$('#ComEx5').css({"color" : "red"});
					}
					else if(checkcon5 < 0 || checkcon5 > 100)
					{
						$('#ComCon5').css({"color" : "red"});
					}
			...
			{				
				...
				if((checkex6 >= 0 && checkex6 <= 100) && (checkcon6 >= 0 && checkcon6 <= 100))
				{
					var ex6 = .7 * parseFloat($('#ComEx6').val());
					var con6 = .3 * parseFloat($('#ComCon6').val());
				}
				else
				{
					if(checkex6 < 0 || checkex6 > 100)
					{
						$('#ComEx6').css({"color" : "red"});
					}
					else if(checkcon6 < 0 || checkcon6 > 100)
					{
						$('#ComCon6').css({"color" : "red"});
					}
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG1').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG1').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG1').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}			
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG1').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG1").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG1").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG1").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG1").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG1').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns1.length <= 5)
		{
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG1').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG1').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG1').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG1').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG1').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG1').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG1').val(char1 + char2 + "0" + "0" + " %");
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG2').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG2').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG2').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}			
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG2').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG2").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG2").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG2").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG2").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG2').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns2.length <= 5)
		{
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG2').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG2').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG2').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG2').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG2').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG2').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG2').val(char1 + char2 + "0" + "0" + " %");
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG3').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG3').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG3').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}			
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG3').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG3").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG3").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG3").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG3").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG3').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns3.length <= 5)
		{
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG3').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG3').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG3').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG3').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG3').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG3').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG3').val(char1 + char2 + "0" + "0" + " %");
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG4').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG4').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG4').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}			
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG4').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG4").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG4").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG4").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG4").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG4').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns4.length <= 5)
		{
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG4').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG4').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG4').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG4').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG4').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG4').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG4').val(char1 + char2 + "0" + "0" + " %");
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG5').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG5').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG5').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}			
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG5').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG5").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG5").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG5").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG5").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG5').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns5.length <= 5)
		{
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG5').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG5').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG5').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG5').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG5').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG5').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG5').val(char1 + char2 + "0" + "0" + " %");
		...
		{	
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char6 == num1[i])
				{
					...
					if (numChar5 <= 9)
					{	
						$('#ComTG6').val(char1 + char2 + char3 + char4 + numChar5 + " %");
					}	
					else if(numChar5 > 9 && char4 <= 8)
					{	
						var numChar4 = parseInt(char4);
						numChar4 += 1;
						$('#ComTG6').val(char1 + char2 + char3 + numChar4 + "0"  + " %");
					}
					else if(numChar5 > 9 && char4 >= 9 && char2 <= 8)
					{
						var numChar2 = parseInt(char2);
						numChar2 += 1;
						$('#ComTG6').val(char1 + numChar2 + char3 + "0" + "0" + " %");
					}		
					else if(numChar5 > 9 && char4 >= 9 && char2 >= 9)
					{
						var numChar1 = parseInt(char1);
						numChar1 += 1;
						$('#ComTG6').val(numChar1 + "0" + char3 + "0" + "0" + " %");
					}	
					else if (char6 >= 5 && char5 >= 5 && char4 <= 8 && char2 == ".")
					{
						var numChar4 = char4;
						numChar4++;
						$("#ComTG6").val(char1 + char2 + char3 + numChar4 + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9 && char2 == "." && char3 <=8)
					{
						var numChar3 = char3;
						numChar3++;
						$("#ComTG6").val(char1 + char2 + numChar3+ "0" + " %");
					}
					else if (char6 >= 5 && char5 >= 5 && char4 >= 9  && char3 >= 9 && char2 == ".")
					{
						var numChar1 = char1;
						numChar1++;
						$("#ComTG6").val(numChar1 + char2 + "0" + "0" + " %");
					}
					else if (char6 >= 5 && char5 <= 8 && char4 <= 8 && char1 <= 8  && char2 <= 9 && char3 == ".")
					{
						var numChar5 = char5;
					...
					{
						$("#ComTG6").val(char1 + char2 + char3 + char4 + " %");
					}		
				}
				else if (char6 == num[i])
				{
					$('#ComTG6').val(char1 + char2 + char3 + char4 + char5 + " %");
				}
			}						
		}
		else if (conAns6.length <= 5)
		{	
			...
			if (isNaN(newChar4) && isNaN(newChar5) && char3 == ".")
			{
				$('#ComTG6').val(char1 + char2 + char3 + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3))
			{			
				$('#ComTG6').val(char1 + char2 + "." + "0" + "0" + " %");
			}
			else if (isNaN(newChar5) && isNaN(newChar4) &&  isNaN(newChar3) && isNaN(newChar2))
			{			
				$('#ComTG6').val(char1 + "0" + "." + "0" + "0" + " %");
			}
			else if (newChar4 >= 0 && newChar5 >= 0 && char3 == ".")
			{
				$('#ComTG6').val(char1 + char2 + char3 + char4 + char5 + " %");
			...
			{
				$('#ComTG6').val(char1 + char2 + char3 + char4 + "0" + " %");
			}
			else if (isNaN(newChar4) && isNaN(newChar5) && char3 >= 0 && char2 == ".") //debug
			{
				$('#ComTG6').val(char1 + char2 + char3 + "0" + " %");
			}
			else if (newChar3 >= 0 && char2 == ".")
			{
				$('#ComTG6').val(char1 + char2 + "0" + "0" + " %");
		...
		var G1 = parseFloat($("#ComTG1").val());
		var G2 = parseFloat($("#ComTG2").val());
		var G3 = parseFloat($("#ComTG3").val());
		var G4 = parseFloat($("#ComTG4").val());
		var G5 = parseFloat($("#ComTG5").val());
		var G6 = parseFloat($("#ComTG6").val());
		...
		$('#ComGradeOne').clearQueue();
		
		//First Grade Point
		if (G1 >= 69.50 && G1 <= 100)
		{
			$('#ComGradeOne').val("[A+] Excellent 4.00 Points");
			G1Total = 4.00;
		}
		else if (G1 >= 64.5 && G1 <= 69.49)
		{
			$('#ComGradeOne').val("[A-] Very Good 3.75 Points");
			G1Total = 3.75;
		}
		else if (G1 >= 59.5 && G1 <= 64.49)
		{
			$('#ComGradeOne').val("[B+] Good 3.25 Points");
			G1Total = 3.25;
		}
		else if (G1 >= 54.5 && G1 <= 59.49)
		{
			$('#ComGradeOne').val("[B] Credit 3.00 Points");
			G1Total = 3.00;
		}
		else if (G1 >= 49.5 && G1 <= 54.49)
		{
			$('#ComGradeOne').val("[B-] Credit 2.75 Points");
			G1Total = 2.75;
		}
		else if (G1 >= 44.5 && G1 <= 49.49)
		{
			$('#ComGradeOne').val("[C+] Pass 2.50 Points");
			G1Total = 2.50;
		}
		else if (G1 >= 39.5 && G1 <= 44.49)
		{
			$('#ComGradeOne').val("[C-] Pass 2.25 Points");
			G1Total = 2.25;
		}
		else if (G1 >= 29.5 && G1 <= 39.49)
		{
			$('#ComGradeOne').val("[D] Fail 1.75 Points");
			G1Total = 1.75;
		}
		else if (G1 >= 0 && G1 <= 29.49)
		{
			$('#ComGradeOne').val("[F] Fail 0.00 Points");
			G1Total = 0.00;
		}
		else
		{
			$('#ComGradeOne').val("Invalid data at Grade One");
		}
		...
		if (G2 >= 69.50 && G2 <= 100)
		{
			$('#ComGradeTwo').val("[A+] Excellent 4.00 Points");
			G2Total = 4.00;
		}
		else if (G2 >= 64.5 && G2 <= 69.49)
		{
			$('#ComGradeTwo').val("[A-] Very Good 3.75 Points");
			G2Total = 3.75;
		}
		else if (G2 >= 59.5 && G2 <= 64.49)
		{
			$('#ComGradeTwo').val("[B+] Good 3.25 Points");
			G2Total = 3.25;
		}
		else if (G2 >= 54.5 && G2 <= 59.49)
		{
			$('#ComGradeTwo').val("[B] Credit 3.00 Points");
			G2Total = 3.00;
		}
		else if (G2 >= 49.5 && G2 <= 54.49)
		{
			$('#ComGradeTwo').val("[B-] Credit 2.75 Points");
			G2Total = 2.75;
		}
		else if (G2 >= 44.5 && G2 <= 49.49)
		{
			$('#ComGradeTwo').val("[C+] Pass 2.50 Points");
			G2Total = 2.50;
		}
		else if (G2 >= 39.5 && G2 <= 44.49)
		{
			$('#ComGradeTwo').val("[C-] Pass 2.25 Points");
			G2Total = 2.25;
		}
		else if (G2 >= 29.5 && G2 <= 39.49)
		{
			$('#ComGradeTwo').val("[D] Fail 1.75 Points");
			G2Total = 1.75;
		}
		else if (G2 >= 0 && G2 <= 29.49)
		{
			$('#ComGradeTwo').val("[F] Fail 0.00 Points");
			G2Total = 0.00;
		}
		else
		{
			$('#ComGradeTwo').val("Invalid data at Grade Two");
		}
		...
		if (G3 >= 69.50 && G3 <= 100)
		{
			$('#ComGradeThree').val("[A+] Excellent 4.00 Points");
			G3Total = 4.00;
		}
		else if (G3 >= 64.5 && G3 <= 69.49)
		{
			$('#ComGradeThree').val("[A-] Very Good 3.75 Points");
			G3Total = 3.75;
		}
		else if (G3 >= 59.5 && G3 <= 64.49)
		{
			$('#ComGradeThree').val("[B+] Good 3.25 Points");
			G3Total = 3.25;
		}
		else if (G3 >= 54.5 && G3 <= 59.49)
		{
			$('#ComGradeThree').val("[B] Credit 3.00 Points");
			G3Total = 3.00;
		}
		else if (G3 >= 49.5 && G3 <= 54.49)
		{
			$('#ComGradeThree').val("[B-] Credit 2.75 Points");
			G3Total = 2.75;
		}
		else if (G3 >= 44.5 && G3 <= 49.49)
		{
			$('#ComGradeThree').val("[C+] Pass 2.50 Points");
			G3Total = 2.50;
		}
		else if (G3 >= 39.5 && G3 <= 44.49)
		{
			$('#ComGradeThree').val("[C-] Pass 2.25 Points");
			G3Total = 2.25;
		}
		else if (G3 >= 29.5 && G3 <= 39.49)
		{
			$('#ComGradeThree').val("[D] Fail 1.75 Points");
			G3Total = 1.75;
		}
		else if (G3 >= 0 && G3 <= 29.49)
		{
			$('#ComGradeThree').val("[F] Fail 0.00 Points");
			G3Total = 0.00;
		}
		else
		{
			$('#ComGradeThree').val("Invalid data at Grade Three");
		...
		if (G4 >= 69.50 && G4 <= 100)
		{
			$('#ComGradeFour').val("[A+] Excellent 4.00 Points");
			G4Total = 4.00;
			
		}
		else if (G4 >= 64.5 && G4 <= 69.49)
		{
			$('#ComGradeFour').val("[A-] Very Good 3.75 Points");
			G4Total = 3.75;
		}
		else if (G4 >= 59.5 && G4 <= 64.49)
		{
			$('#ComGradeFour').val("[B+] Good 3.25 Points");
			G4Total = 3.25;
		}
		else if (G4 >= 54.5 && G4 <= 59.49)
		{
			$('#ComGradeFour').val("[B] Credit 3.00 Points");
			G4Total = 3.00;
		}
		else if (G4 >= 49.5 && G4 <= 54.49)
		{
			$('#ComGradeFour').val("[B-] Credit 2.75 Points");
			G4Total = 2.75;
		}
		else if (G4 >= 44.5 && G4 <= 49.49)
		{
			$('#ComGradeFour').val("[C+] Pass 2.50 Points");
			G4Total = 2.50;
		}
		else if (G4 >= 39.5 && G4 <= 44.49)
		{
			$('#ComGradeFour').val("[C-] Pass 2.25 Points");
			G4Total = 2.25;
		}
		else if (G4 >= 29.5 && G4 <= 39.49)
		{
			$('#ComGradeFour').val("[D] Fail 1.75 Points");
			G4Total = 1.75;
		}
		else if (G4 >= 0 && G4 <= 29.49)
		{
			$('#ComGradeFour').val("[F] Fail 0.00 Points");
			G4Total = 0.00;
		}
		else
		{
			$('#ComGradeFour').val("Invalid data at Grade Four");
		...
		if (G5 >= 69.50 && G5 <= 100)
		{
			$('#ComGradeFive').val("[A+] Excellent 4.00 Points");
			G5Total = 4.00;
		}
		else if (G5 >= 64.5 && G5 <= 69.49)
		{
			$('#ComGradeFive').val("[A-] Very Good 3.75 Points");
			G5Total = 3.75;
		}
		else if (G5 >= 59.5 && G5 <= 64.49)
		{
			$('#ComGradeFive').val("[B+] Good 3.25 Points");
			G5Total = 3.25;
		}
		else if (G5 >= 54.5 && G5 <= 59.49)
		{
			$('#ComGradeFive').val("[B] Credit 3.00 Points");
			G5Total = 3.00;
		}
		else if (G5 >= 49.5 && G5 <= 54.49)
		{
			$('#ComGradeFive').val("[B-] Credit 2.75 Points");
			G5Total = 2.75;
		}
		else if (G5 >= 44.5 && G5 <= 49.49)
		{
			$('#ComGradeFive').val("[C+] Pass 2.50 Points");
			G5Total = 2.50;
		}
		else if (G5 >= 39.5 && G5 <= 44.49)
		{
			$('#ComGradeFive').val("[C-] Pass 2.25 Points");
			G5Total = 2.25;
		}
		else if (G5 >= 29.5 && G5 <= 39.49)
		{
			$('#ComGradeFive').val("[D] Fail 1.75 Points");
			G5Total = 1.75;
		}
		else if (G5 >= 0 && G5 <= 29.49)
		{
			$('#ComGradeFive').val("[F] Fail 0.00 Points");
			G5Total = 0.00;
		}
		else
		{
			$('#ComGradeFive').val("Invalid data at Grade Five");
		}
		...
		if (G6 >= 69.50 && G6 <= 100)
		{
			$('#ComGradeSix').val("[A+] Excellent 4.00 Points");
			G6Total = 4.00;
		}
		else if (G6 >= 64.5 && G6 <= 69.49)
		{
			$('#ComGradeSix').val("[A-] Very Good 3.75 Points");
			G6Total = 3.75;
		}
		else if (G6 >= 59.5 && G6 <= 64.49)
		{
			$('#ComGradeSix').val("[B+] Good 3.25 Points");
			G6Total = 3.25;
		}
		else if (G6 >= 54.5 && G6 <= 59.49)
		{
			$('#ComGradeSix').val("[B] Credit 3.00 Points");
			G6Total = 3.00;
		}
		else if (G6 >= 49.5 && G6 <= 54.49)
		{
			$('#ComGradeSix').val("[B-] Credit 2.75 Points");
			G6Total = 2.75;
		}
		else if (G6 >= 44.5 && G6 <= 49.49)
		{
			$('#ComGradeSix').val("[C+] Pass 2.50 Points");
			G6Total = 2.50;
		}
		else if (G6 >= 39.5 && G6 <= 44.49)
		{
			$('#ComGradeSix').val("[C-] Pass 2.25 Points");
			G6Total = 2.25;
		}
		else if (G6 >= 29.5 && G6 <= 39.49)
		{
			$('#ComGradeSix').val("[D] Fail 1.75 Points");
			G6Total = 1.75;
		}
		else if (G6 >= 0 && G6 <= 29.49)
		{
			$('#ComGradeSix').val("[F] Fail 0.00 Points");
			G6Total = 0.00;
		}
		else
		{
			$('#ComGradeSix').val("Invalid data at Grade Six");
			...
			for (var i = 0; i <= 4; i++)
			{
				if (char5 == num1[i])
				{
					...
					{	
						...
						$('#ComAverageGP').val("AGP is " + char1 + char2 + char3 + numChar4 + " Point");
					}	
					else if(numChar4 > 9 && char3 <= 8)
					{	
						var numChar3 = parseInt(char3);
						...
						$('#ComAverageGP').val("AGP is " + char1 + char2 + numChar3 + " Point");
					}
					else if(numChar4 > 9 && char3 >= 9 && char1 <= 4)
					{
						var numChar1 = parseInt(char1);
						...
						$('#ComAverageGP').val("AGP is " + numChar1 + char2 + "0" + " Point");
					}			
					else if(numChar4 > 9 && char3 >= 9 && char1 > 4)
					{
						
						$('#ComAverageGP').val("Data Error");
					}			
				}
				else if (char5 == num[i])
				{	
					CommentAGP = ("AGP is " + char1 + char2 + char3 + char4 + " Point").toString();
					$('#ComAverageGP').val("AGP is " + char1 + char2 + char3 + char4 + " Point");
				}
			}						
		}
		else if (conAns.length <= 4)
		{
			...
			{		
				...
				$('#ComAverageGP').val("AGP is " + char1 + char2 + char3 + "0" + " Point");
			}	
			else if (isNaN(newChar3) && isNaN(newChar4) && char2 == ".")
			{
				CommentAGP = ("AGP is " + char1 + char2 + "0" + "0" + " Point").toString();
				$('#ComAverageGP').val("AGP is " + char1 + char2 + "0" + "0" + " Point");
			}
			else if(newChar3 >= 0 && newChar4 >= 0 && char2 == ".")
			{
				CommentAGP = ("AGP is " + char1 + char2 + char3 + char4 + " Point").toString();
			...
			else if (char2 != "." && char1 >= 0)
			{
				...
				$('#ComAverageGP').val("AGP is " + char1 + "." + "0" + "0" + " Point");
			}
			else if (isNaN(char1))
			{	
